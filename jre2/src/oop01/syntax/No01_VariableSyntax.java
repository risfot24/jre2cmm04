...
/*
 ...
 Member Variable in a class-these are called fields. (클래스 내부에 멤버 변수들을 집합) 필드라 부른다. 
...
/*
 변수의 종류
 - 클래스 변수 (클래스 열외, 클래스가 메모리에 올라갈 때 가장 먼저 생성)
...
/*
  클래스 변수 (class variable = static variable) ?
   - 같은 클래스의 모든 인스턴스 들이 같은 값으로 공유하는 변수
...
public class No01_VariableSyntax {
